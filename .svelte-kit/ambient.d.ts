...
declare module '$env/static/private' {
	...
	export const APPLE_ID_PASSWORD: string;
	...
	export const CSC_IDENTITY_AUTO_DISCOVERY: string;
	export const LESS_TERMCAP_us: string;
	export const LSCOLORS: string;
	export const APPLE_TEAM_ID: string;
	export const SSH_NAME: string;
	...
	export const APPLE_APP_SPECIFIC_PASSWORD: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_execpath: string;
		PAGER: string;
		CSC_IDENTITY_AUTO_DISCOVERY: string;
